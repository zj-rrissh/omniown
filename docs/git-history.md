...
OmniOwn 的提交历史显示项目已从早期 Rust 本地文件处理工具，演进为面向桌面交付的全栈本地文档管理应用。当前重点已经从功能搭建转向 UI 体验优化和搜索质量提升。

**近期进展（2026-06-22）：**
- 引入 Element Plus 组件库，替换搜索页和文档页的原生组件
- 底部导航栏改为 Element Plus 图标
- 详情面板从内联遮罩改为 El-drawer 抽屉组件
- 分页从自定义按钮改为 El-pagination 组件
